var xlsxUtils = {
     ...
     * @desc 创建下载文件
     * @param {Blob} e  数据对象
     * @param {String} t 下载文件名
     */
    saveAs(e,t){
        if(!("string"!=typeof e||e.length<=0))
        {
            var n=document.createElement("a");
            n.id="download-"+Date.parse(new Date);
            n.href=e,n.download=t||"";
            n.style="opacity: 0;height: 1px;width: 1px;overflow: hidden;position:fixed;top: -1;left: -1;z-index: -1;";
            document.body.appendChild(n);
            document.getElementById(n.id).click();
            document.body.removeChild(document.getElementById(n.id));
        }}
};
