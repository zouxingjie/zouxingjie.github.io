...
THREEx.ArPatternFile.buildFullMarker2 = function (innerImageURL, pattRatio, onComplete) {
	...
	// copy image on canvas
	var innerImage0 = document.createElement('img')
	innerImage0.addEventListener('load', function () {
		// draw innerImage
		context.drawImage(innerImage0,
			0,
			0,
			canvas.width,
			canvas.height
	...
	innerImage0.src = "inner-images/AR-A3-2.png";
	...
	innerImage.src = "inner-images/ARmarker.png";
}